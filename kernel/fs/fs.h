...
#define NDIRECT 10
// Number of block addresses that can be stored in a single-level indirect block
#define NINDIRECT (BSIZE / sizeof(uint32_t))

// Maximum number of data blocks a single file can use
...
struct dinode {
  ...
  uint32_t indirect;       // single indirect block (array of block numbers)
};
...
// Built-in README content (automatically generated by the build script from
// the top-level README.md)
extern const unsigned int README_MD_SIZE;
extern const unsigned char README_MD[];
